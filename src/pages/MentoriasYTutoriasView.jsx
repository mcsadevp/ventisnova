              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 md:gap-12 gap-4">
                ...
                <div className="bg-white shadow-lg rounded-lg overflow-hidden border-2 border-customGreen">
                  ...
                  <div className="p-4">
                    ...
                    <p className="text-gray-600 mb-4 text-sm">Aprendé a transformar oportunidades en proyectos rentables a través de clases teóricas dadas. Descubrí estrategias claves para desarrollar tu negocio, desde la planificación hasta la ejecución. ¡Preparate para llevar tus ideas al siguiente nivel!</p>
                    <div className='flex items-center mb-2'>
                      <p className='text-sm font-semibold'>Online en vivo</p>
                      <div className='w-4 h-4 bg-red-300 rounded-full flex justify-center items-center ml-1'>
                        <div className='w-2 h-2 bg-red-600 rounded-full'></div>
