      ...
      {/* Hero & nabvar*/}
          <div className='bg-cover' style={{ backgroundImage: `url(${ semiCirculos })` }}>
              ...
              <div className=' w-full py-20 px-24'>
                  <h1 className='text-white md:text-5xl text-3xl font-bold '>TUTORIAS</h1>
                  ...
                  <div className='mt-6 flex justify-center md:justify-start w-full'>
                      <button onClick={ () => window.location.href='https://wa.me/5491166850200?text=Hola%20me%20gustaría%20saber%20más%20información%20sobre%20las%20tutorías.' } className='mt-4 md:mt-0 py-4 px-6 bg-white rounded-md hover:bg-customGreen hover:text-white transition-all font-semibold'>
                          Inscribirme ahora
                      </button>
                  </div>
              </div>
